...
class ObjectDetectionTrainer:
    ...
    def train_model(self, resX, resY, sol_num, epoch, ifSaved, print_freq):
        ...
        with torch.no_grad():
            ...
            ## For using mAP0.5-0.95
            # mAP = 0
            # for iou_thres in np.arange(0.5, 1, 0.5):
            #     mAP += metrics.mean_average_precision(pred_box, true_box, iou_threshold=iou_thres, num_classes=self.num_classes)
            #
            # mAP = mAP/10
