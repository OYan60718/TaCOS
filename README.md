...
3. Download the assets used for this project from Unreal Engine Marketplace and add them to the project. However, other perferred assets can be added to this project. The assets includes:
